...
iterations = 120000     # Total number of SGD steps
...
fig.suptitle(r"ReLU network - Target: $y(x) = |x|$ (Particle Gradient Flow)", fontsize=16)
...
ani.save("sgd_evolution_abs.gif", writer='pillow', fps=15, dpi=150)
print("File sgd_evolution_abs.gif saved with success!")
