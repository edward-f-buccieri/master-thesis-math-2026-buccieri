...
jko_steps = 100      # Number of JKO iterations
...
ani.save("jko_evolution_quad.gif", writer='pillow', fps=15, dpi=150)
print("File jko_evolution_quad.gif saved with success!")
