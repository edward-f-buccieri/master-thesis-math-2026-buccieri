...
save_interval = iterations // 150  # Save history periodically for the animation (150 frames)
...
fig.suptitle(r"ReLU network - Target: Oscillating Function (Particle Gradient Flow)", fontsize=16)
...
ani.save("sgd_evolution_osc.gif", writer='pillow', fps=15, dpi=150)
print("File sgd_evolution_osc.gif saved with success!")
