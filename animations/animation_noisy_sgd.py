...
ax_2d.scatter(x_np, y_np, color='gray', s=10, alpha=0.4, label="Target")
...
ani.save("sgd_evolution_noisy.gif", writer='pillow', fps=15, dpi=150)
print("File sgd_evolution_noisy.gif saved with success!")
